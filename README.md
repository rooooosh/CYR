...
**Develop: |**
Bij aanvang van het tweede semester (week 13) wordt de derde en laatste diamond betreden. Dit volledige tweede semester zal er gefocust worden op de develop fase. Deze fase wordt opgesplitst in 3 grote deelopdrachten elk met een bepaald doel te bereiken. 
...
<p align="left">
  ...
  <img src="CYR PICS/Touchbox 4.jpeg" width="32%">
...
[<img src="/CYR PICS/Thumbnail.png" width="50%">](https://youtu.be/sCeQrx-kPlM)
...
> [!IMPORTANT]
> Makey Makey maakt gebruik van capacitive touch waardoor een simpele aanraking met één van de toetsen al een geluid creëert. 
...
<p align="left">
  <img src="CYR PICS/TEST.jpg" width="44.5%">
...
>  - 1.2 De boombox bevat een minimale grootte voor het ondersteunen van een scherm.
>  - 2.1 De touchbox produceert geluid door een enkele aanraking met één van de toetsen.
>  - 2.2 Het indrukken van de knoppen op de touchbox gebeurt aan de hand van capacitive touch.
>  - 2.3 Elke toets wordt afgebeeld met een ander symbool.
>  - 3.1 De boombox heeft een functieknop aan de zijkant om het ritme van muziek aan/uit te schakelen.
>  - 3.2 De boombox bevat verschillende knoppen om een keuze te maken uit verschillende liedjes.
>  - 4.1 De dimensies van de touchbox (25,5cm x 17,5cm) maken het mogelijk deze makkelijk op te bergen.
>  - 4.2 De drukknoppen hebben een minimale diameter 4-6cm om een keuze uit liedjes te maken.
>  - 4.3 De toetsen bevinden zich in een dicht gestapeld raster (2x2, 3x2, 3x3) om multi-touch mogelijk te maken.
...
<p align="left">
  ...
  Het toevoegen van een extra kleurelement werd besproken op basis van Plutchik's 'Wheel of Emotion'. Hieruit bleek dat een gele tint geschikt zou zijn voor het ontwerp. Uiteindelijk is deze keuze niet verder uitgewerkt, omdat er onvoldoende tijd was om dit grondig te integreren in het product. De keuze voor een kleur zou bovendien moeten aansluiten bij het onderzoek naar de kleurenthema's van het ingebouwde spel.
<p align="left">
