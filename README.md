...
<p align="left">
  ...
  <img src="CYR PICS/CYR met Ipad volledige setup 1.jpeg" width="32%">
...
## Kritische reflectie
Bij het aangaan van dit project zijn we goed begonnen, na het samenkomen na de pitches zijn we direct beginnen overleggen wat we goed vinden en wat we toen al zouden kunnen verbeteren aan het concept, met de feedback gekregen uit de pitch. 

Hierna hebben we even gebrainstormd over wat we zouden kunnen doen voor de verschillende waves. We zijn hierna overgegaan tot de prototyping fase, dit hebben we misschien wel wat te snel gedaan, dit had als gevolg dat we tijdens de tests af en toe iets onverwachts meemaakten. Dit zijn waren dingen zoals Protopie dat een update nodig had, 1 gebruiker dat door haar huid problemen had met Makey Makey,…

Desondanks haalt dit niet weg dat we tevreden zijn met de resultaten van de waves. We hebben er veel uit geleerd en hebben motivatie gekregen om verder te werken aan het project. Vaak vroegen de gebruikers ons na de test om hen op de hoogte te houden, en vertelden ze ons dat we hen nog mochten contacteren, indien we dat nodig zouden hebben. 

Waar we het vooral lastig mee hadden was het contacteren van gebruikers om de waves mee uit te voeren. Door de moeilijke doelgroep, was er geen optie waar we alle tests op 1 dag zouden kunnen uitvoeren. De doelgroep waarbij we wouden testen zit nog niet in een rusthuis en is niet altijd even mobiel. De meesten hadden dus liever dat wij naar hen zouden komen, wat geen probleem vormde, maar het logistiek wel wat moeilijker maakte. 

We zijn ook gestart met het uitvoeren van wave 1 apart, hier hebben we het onszelf lastig gemaakt. 
...
Deze korte tegenslagen terzijde, verliep de samenwerking en de progressie die we hebben gemaakt in het proces wel goed. We zijn klaar om met de gekregen resultaten naar een volgende fase te gaan.
